...
public:
	...
	uint8                                        Pad_47[0x50];                                      // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_48[0xD];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_49[0x38];                                      // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_58[0x1];                                       // Fixing Size Of Struct [ Dumper-7 ]
};
