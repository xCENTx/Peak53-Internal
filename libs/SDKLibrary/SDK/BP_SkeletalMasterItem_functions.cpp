...
#include "BP_SkeletalMasterItem_parameters.hpp"
...
bool ABP_SkeletalMasterItem_C::ActionCheck(TArray<struct FS_WorldAction>& ItemActions, E_WorldActions ActionType)
{
	...
	Params::BP_SkeletalMasterItem_C_ActionCheck Parms{};

	Parms.ItemActions = std::move(ItemActions);
	Parms.ActionType = ActionType;

	UObject::ProcessEvent(Func, &Parms);

	ItemActions = std::move(Parms.ItemActions);
...
void ABP_SkeletalMasterItem_C::Consume(class UBP_PlayerInventory_C* PlayerInventory)
{
	...
	Params::BP_SkeletalMasterItem_C_Consume Parms{};
...
void ABP_SkeletalMasterItem_C::CreateItem(class ABP_GlobalInventoryManager_C* InventoryManager)
{
	...
	Params::BP_SkeletalMasterItem_C_CreateItem Parms{};
...
void ABP_SkeletalMasterItem_C::EquipClothing(class UBP_PlayerInventory_C* PlayerInventory)
{
	...
	Params::BP_SkeletalMasterItem_C_EquipClothing Parms{};
...
void ABP_SkeletalMasterItem_C::EquipWeapon(class UBP_PlayerInventory_C* PlayerInventory)
{
	...
	Params::BP_SkeletalMasterItem_C_EquipWeapon Parms{};
...
void ABP_SkeletalMasterItem_C::ExecuteUbergraph_BP_SkeletalMasterItem(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_SkeletalMasterItem_C_ExecuteUbergraph_BP_SkeletalMasterItem Parms{};
...
void ABP_SkeletalMasterItem_C::Hold(class UBP_PlayerInventory_C* PlayerInventory)
{
	...
	Params::BP_SkeletalMasterItem_C_Hold Parms{};
...
void ABP_SkeletalMasterItem_C::Interact(class UBP_PlayerInventory_C* PlayerInventory)
{
	...
	Params::BP_SkeletalMasterItem_C_Interact Parms{};
...
void ABP_SkeletalMasterItem_C::InteractActions(class UBP_PlayerInventory_C* PlayerInventory, E_WorldActions Action)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_SkeletalMasterItem_C_InteractActions Parms{};
...
void ABP_SkeletalMasterItem_C::Learn(class UBP_PlayerInventory_C* PlayerInventory)
{
	...
	Params::BP_SkeletalMasterItem_C_Learn Parms{};
...
void ABP_SkeletalMasterItem_C::LoadItem(class UBP_SGKSaveGame_C* Param_SaveGame)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_SkeletalMasterItem_C_LoadItem Parms{};
...
// Parameters:
// class USkeletalMesh*                    Param_SkeletalMesh                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, NoDestructor, HasGetValueTypeHash)

void ABP_SkeletalMasterItem_C::MulticastUpdateMesh(class USkeletalMesh* Param_SkeletalMesh)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_SkeletalMasterItem_C_MulticastUpdateMesh Parms{};
...
void ABP_SkeletalMasterItem_C::Open(class UBP_PlayerInventory_C* PlayerInventory)
{
	...
	Params::BP_SkeletalMasterItem_C_Open Parms{};
...
void ABP_SkeletalMasterItem_C::Pickup(class UBP_PlayerInventory_C* PlayerInventory)
{
	...
	Params::BP_SkeletalMasterItem_C_Pickup Parms{};
...
void ABP_SkeletalMasterItem_C::SGK_AllowInteraction(bool* AllowInteraction)
{
	...
	Params::BP_SkeletalMasterItem_C_SGK_AllowInteraction Parms{};
...
void ABP_SkeletalMasterItem_C::SGK_CodeCheck(const class FText& Code, bool* CodeAccepted)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_SkeletalMasterItem_C_SGK_CodeCheck Parms{};
...
bool ABP_SkeletalMasterItem_C::SGK_DropItem(const struct FS_InvItem& Param_InvItem, bool Param_Dropped, bool Param_Spawned, bool SaveLoaded)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_SkeletalMasterItem_C_SGK_DropItem Parms{};
...
bool ABP_SkeletalMasterItem_C::SGK_EndInteraction(class UBP_PlayerInventory_C* PlayerInventory)
{
	...
	Params::BP_SkeletalMasterItem_C_SGK_EndInteraction Parms{};
...
void ABP_SkeletalMasterItem_C::SGK_GetVerifiedPlayers(TArray<class FText>* VerifiedPlayers)
{
	...
	Params::BP_SkeletalMasterItem_C_SGK_GetVerifiedPlayers Parms{};
...
bool ABP_SkeletalMasterItem_C::SGK_Interact(class UBP_PlayerInventory_C* PlayerInventory, E_WorldActions Action)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_SkeletalMasterItem_C_SGK_Interact Parms{};
...
void ABP_SkeletalMasterItem_C::SGK_InteractName(class FText* InteractName)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_SkeletalMasterItem_C_SGK_InteractName Parms{};
...
void ABP_SkeletalMasterItem_C::SGK_InvItem(bool* IsItem, struct FS_InvItem* Param_InvItem)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_SkeletalMasterItem_C_SGK_InvItem Parms{};
...
void ABP_SkeletalMasterItem_C::SGK_ItemAmount(int32* Amount)
{
	...
	Params::BP_SkeletalMasterItem_C_SGK_ItemAmount Parms{};
...
void ABP_SkeletalMasterItem_C::SGK_Mesh(class UPrimitiveComponent** Param_Mesh)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_SkeletalMasterItem_C_SGK_Mesh Parms{};
...
void ABP_SkeletalMasterItem_C::SGK_PossibleActions(class UBP_PlayerInventory_C* PlayerInventory, bool* ActionsFound, TArray<struct FS_WorldAction>* PossibleActions)
{
	...
	Params::BP_SkeletalMasterItem_C_SGK_PossibleActions Parms{};
...
void ABP_SkeletalMasterItem_C::SGK_SetVerifiedPlayers(TArray<class FText>& VerifiedPlayers)
{
	...
	Params::BP_SkeletalMasterItem_C_SGK_SetVerifiedPlayers Parms{};
...
void ABP_SkeletalMasterItem_C::SGK_TurnedOnEffect(bool TurnedOn)
{
	...
	Params::BP_SkeletalMasterItem_C_SGK_TurnedOnEffect Parms{};
...
bool ABP_SkeletalMasterItem_C::SGK_UpdateCode(const class FText& Code)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_SkeletalMasterItem_C_SGK_UpdateCode Parms{};
...
bool ABP_SkeletalMasterItem_C::SGK_VerifyPlayer(const class FText& Text)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_SkeletalMasterItem_C_SGK_VerifyPlayer Parms{};
...
void ABP_SkeletalMasterItem_C::SGKSave(class UBP_SGKSaveGame_C* Save)
{
	...
	Params::BP_SkeletalMasterItem_C_SGKSave Parms{};
...
void ABP_SkeletalMasterItem_C::SpawnAttachments(const struct FS_InvItem& Param_InvItem)
{
	static class UFunction* Func = nullptr;
	...
	Params::BP_SkeletalMasterItem_C_SpawnAttachments Parms{};
