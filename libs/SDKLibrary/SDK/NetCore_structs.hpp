...
{
public:
	uint8                                        Pad_2A4E[0x54];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2A4F[0xA8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2A50[0x7];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_2A56[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2A57[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2A59[0x6];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
