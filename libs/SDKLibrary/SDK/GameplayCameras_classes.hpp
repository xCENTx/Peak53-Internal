...
public:
	...
	uint8                                        Pad_742[0x70];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_744[0x28];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_7C0[0x38];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_7C4[0x3C];                                     // Fixing Size Of Struct [ Dumper-7 ]
