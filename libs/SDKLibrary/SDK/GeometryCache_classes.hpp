...
public:
	...
	uint8                                        Pad_1FAA[0x4C];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1FAC[0xC];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1FAD[0x2C];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1FB1[0x24];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_1FB2[0x68];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1FB5[0xC8];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1FB7[0xC8];                                    // Fixing Size Of Struct [ Dumper-7 ]
