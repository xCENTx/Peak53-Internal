...
class ABP_M11_SD_C : public ABP_MasterRangeWeapon_C
{
public:
	...
	class UStaticMeshComponent*                  SM_Rearwiew;                                       // 0xD58(0x8)(BlueprintVisible, ZeroConstructor, InstancedReference, NonTransactional, NoDestructor, HasGetValueTypeHash)

	static class UClass* StaticClass();
	static class ABP_M11_SD_C* GetDefaultObj();
