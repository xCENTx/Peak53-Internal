...
class USUMMIT_WIDGET_C : public UUserWidget
{
public:
	...
	static class USUMMIT_WIDGET_C* GetDefaultObj();

	void Construct();
	void ExecuteUbergraph_SUMMIT_WIDGET(int32 EntryPoint, bool CallFunc_OpenSource_ReturnValue);
};
