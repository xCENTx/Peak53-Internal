...
class UINK_RUINS_WIDGET_C : public UUserWidget
{
public:
	...
	static class UINK_RUINS_WIDGET_C* GetDefaultObj();

	void Construct();
	void ExecuteUbergraph_INK_RUINS_WIDGET(int32 EntryPoint, bool CallFunc_OpenSource_ReturnValue);
};
