...
class ABP_INS_RATTLESNAKE_TRAIL_MX1_C : public ABP_SGKMasterCharacter_C
{
public:
	...
	static class ABP_INS_RATTLESNAKE_TRAIL_MX1_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void ExecuteUbergraph_BP_INS_RATTLESNAKE_TRAIL_MX1(int32 EntryPoint);
};
