...
class ABP_SEAL_CROSSROADS_MX1_C : public ABP_SGKMasterCharacter_C
{
public:
	...
	static class ABP_SEAL_CROSSROADS_MX1_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void ExecuteUbergraph_BP_SEAL_CROSSROADS_MX1(int32 EntryPoint);
};
