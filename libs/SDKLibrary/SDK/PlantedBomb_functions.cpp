...
class UClass* APlantedBomb_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("PlantedBomb_C");

	return Clss;
}


// PlantedBomb_C PlantedBomb.Default__PlantedBomb_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class APlantedBomb_C* APlantedBomb_C::GetDefaultObj()
{
	static class APlantedBomb_C* Default = nullptr;

	if (!Default)
		Default = static_cast<APlantedBomb_C*>(APlantedBomb_C::StaticClass()->DefaultObject);

	return Default;
}


// Function PlantedBomb.PlantedBomb_C.ReceiveBeginPlay
// (Event, Protected, BlueprintEvent)
// Parameters:

void APlantedBomb_C::ReceiveBeginPlay()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("PlantedBomb_C", "ReceiveBeginPlay");
...
void APlantedBomb_C::BndEvt__BombItem_Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex, bool bFromSweep, struct FHitResult& SweepResult)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("PlantedBomb_C", "BndEvt__BombItem_Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature");

	Params::APlantedBomb_C_BndEvt__BombItem_Box_K2Node_ComponentBoundEvent_0_ComponentBeginOverlapSignature__DelegateSignature_Params Parms{};
...
void APlantedBomb_C::BndEvt__PlantedBomb_Box_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature(class UPrimitiveComponent* OverlappedComponent, class AActor* OtherActor, class UPrimitiveComponent* OtherComp, int32 OtherBodyIndex)
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("PlantedBomb_C", "BndEvt__PlantedBomb_Box_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature");

	Params::APlantedBomb_C_BndEvt__PlantedBomb_Box_K2Node_ComponentBoundEvent_1_ComponentEndOverlapSignature__DelegateSignature_Params Parms{};
...
// Function PlantedBomb.PlantedBomb_C.ReceiveDestroyed
// (Event, Public, BlueprintEvent)
// Parameters:

void APlantedBomb_C::ReceiveDestroyed()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("PlantedBomb_C", "ReceiveDestroyed");
...
// class AGameManager_C*              CallFunc_Array_Get_Item                                          (ZeroConstructor, NoDestructor, HasGetValueTypeHash)
