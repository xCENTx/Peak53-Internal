...
class UCASTLE_FALCON_WIDGET_C : public UUserWidget
{
public:
	...
	static class UCASTLE_FALCON_WIDGET_C* GetDefaultObj();

	void Construct();
	void ExecuteUbergraph_CASTLE_FALCON_WIDGET(int32 EntryPoint, bool CallFunc_OpenSource_ReturnValue);
};
