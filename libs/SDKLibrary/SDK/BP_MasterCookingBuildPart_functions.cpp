...
class UClass* ABP_MasterCookingBuildPart_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_MasterCookingBuildPart_C");

	return Clss;
}


// BP_MasterCookingBuildPart_C BP_MasterCookingBuildPart.Default__BP_MasterCookingBuildPart_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class ABP_MasterCookingBuildPart_C* ABP_MasterCookingBuildPart_C::GetDefaultObj()
{
	static class ABP_MasterCookingBuildPart_C* Default = nullptr;

	if (!Default)
		Default = static_cast<ABP_MasterCookingBuildPart_C*>(ABP_MasterCookingBuildPart_C::StaticClass()->DefaultObject);
...
void ABP_MasterCookingBuildPart_C::LoadExtraCookingData(class UBP_SGKSaveGame_C* Save, int32 Index, const class FString& CallFunc_GetCurrentLevelName_ReturnValue, bool CallFunc_SelectLevelSaveData_SaveFound, const struct FS_LevelSaveData& CallFunc_SelectLevelSaveData_LevelSaveData, bool CallFunc_Array_IsValidIndex_ReturnValue, const struct FS_CookingSave& CallFunc_Array_Get_Item)
{
	...
	Params::ABP_MasterCookingBuildPart_C_LoadExtraCookingData_Params Parms{};
...
bool ABP_MasterCookingBuildPart_C::SGK_EndInteraction(class UBP_PlayerInventory_C* PlayerInventory, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_LessEqual_IntInt_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_MasterCookingBuildPart_C_SGK_EndInteraction_Params Parms{};
...
void ABP_MasterCookingBuildPart_C::SGK_PossibleActions(class UBP_PlayerInventory_C* PlayerInventory, bool* ActionsFound, TArray<struct FS_WorldAction>* PossibleActions, const struct FS_WorldAction& K2Node_MakeStruct_S_WorldAction, TArray<struct FS_WorldAction>& K2Node_MakeArray_Array)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_MasterCookingBuildPart_C_SGK_PossibleActions_Params Parms{};
...
void ABP_MasterCookingBuildPart_C::SGK_AllowInteraction(bool* AllowInteraction)
{
	...
	Params::ABP_MasterCookingBuildPart_C_SGK_AllowInteraction_Params Parms{};
...
bool ABP_MasterCookingBuildPart_C::SGK_Interact(class UBP_PlayerInventory_C* PlayerInventory, enum class E_WorldActions Action, bool CallFunc_EqualEqual_ByteByte_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_MasterCookingBuildPart_C_SGK_Interact_Params Parms{};
...
void ABP_MasterCookingBuildPart_C::SaveExtraData(class UBP_SGKSaveGame_C* SaveGame, const struct FS_LevelSaveData& LevelSaveData, int32* ExtraDataIndex, struct FS_LevelSaveData* NewLevelSaveData, int32 CallFunc_PrepareCookingSaveData_ExtraDataIndex, const struct FS_LevelSaveData& CallFunc_PrepareCookingSaveData_NewLevelSaveData)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_MasterCookingBuildPart_C_SaveExtraData_Params Parms{};
...
void ABP_MasterCookingBuildPart_C::SGK_LoadExtraData(class UBP_SGKSaveGame_C* SaveGame, int32 Index)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_MasterCookingBuildPart_C_SGK_LoadExtraData_Params Parms{};
...
void ABP_MasterCookingBuildPart_C::ExecuteUbergraph_BP_MasterCookingBuildPart(int32 EntryPoint, TArray<class AActor*>& Temp_object_Variable, class UBP_SGKSaveGame_C* K2Node_Event_SaveGame, int32 K2Node_Event_Index, TArray<enum class EObjectTypeQuery>& K2Node_MakeArray_Array, const struct FVector& CallFunc_K2_GetActorLocation_ReturnValue, TArray<class AActor*>& CallFunc_SphereOverlapActors_OutActors, bool CallFunc_SphereOverlapActors_ReturnValue, bool CallFunc_IsValid_ReturnValue, bool CallFunc_IsValid_ReturnValue_1)
{
	static class UFunction* Func = nullptr;
	...
	Params::ABP_MasterCookingBuildPart_C_ExecuteUbergraph_BP_MasterCookingBuildPart_Params Parms{};
