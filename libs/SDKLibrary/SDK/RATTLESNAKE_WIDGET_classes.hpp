...
class URATTLESNAKE_WIDGET_C : public UUserWidget
{
public:
	...
	static class URATTLESNAKE_WIDGET_C* GetDefaultObj();

	void Construct();
	void ExecuteUbergraph_RATTLESNAKE_WIDGET(int32 EntryPoint, bool CallFunc_OpenSource_ReturnValue);
};
