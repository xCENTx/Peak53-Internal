...
class UFROSTFIRE_WIDGET_C : public UUserWidget
{
public:
	...
	static class UFROSTFIRE_WIDGET_C* GetDefaultObj();

	void Construct();
	void ExecuteUbergraph_FROSTFIRE_WIDGET(int32 EntryPoint, bool CallFunc_OpenSource_ReturnValue);
};
