...
struct ABP_GeoContainer_C_CheckLocks_Params
{
public:
...
struct ABP_GeoContainer_C_SGK_AllowInteraction_Params
{
public:
...
struct ABP_GeoContainer_C_SGK_PossibleActions_Params
{
public:
...
struct ABP_GeoContainer_C_SGK_Interact_Params
{
public:
	class UBP_PlayerInventory_C*                 PlayerInventory;                                   // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
struct ABP_GeoContainer_C_ExecuteUbergraph_BP_GeoContainer_Params
{
public:
