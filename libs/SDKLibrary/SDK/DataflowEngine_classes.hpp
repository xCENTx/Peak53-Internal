...
{
public:
	uint8                                         Pad_3279[0x20];                                    // 0x0098(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_327A[0x10];                                    // 0x0060(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_327B[0x7];                                     // 0x0071(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
