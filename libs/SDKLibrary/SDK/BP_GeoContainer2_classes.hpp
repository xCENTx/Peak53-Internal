...
class ABP_GeoContainer2_C : public ABP_MasterBuildPart_C
{
public:
	struct FPointerToUberGraphFrame              UberGraphFrame;                                    // 0x380(0x8)(ZeroConstructor, Transient, DuplicateTransient)
	float                                        SwingOpen_Rotation_C2D97E3E434F5F36A7B71A8E46244AE7; // 0x388(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ETimelineDirection                SwingOpen__Direction_C2D97E3E434F5F36A7B71A8E46244AE7; // 0x38C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	float                                        SwingClosed_Rotation_A27B9B2246211C6302DE3B8DD0403650; // 0x398(0x4)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	enum class ETimelineDirection                SwingClosed__Direction_A27B9B2246211C6302DE3B8DD0403650; // 0x39C(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	static class ABP_GeoContainer2_C* GetDefaultObj();
