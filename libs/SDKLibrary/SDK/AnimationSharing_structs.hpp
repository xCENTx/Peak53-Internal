...
public:
	...
	uint8                                        Pad_1CCA[0x2];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1CCD[0x3];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1CD4[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
};
