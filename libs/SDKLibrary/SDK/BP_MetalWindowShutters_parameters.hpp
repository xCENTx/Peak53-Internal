...
struct ABP_MetalWindowShutters_C_CheckLocks_Params
{
public:
...
struct ABP_MetalWindowShutters_C_SGK_InteractName_Params
{
public:
...
struct ABP_MetalWindowShutters_C_SGK_PossibleActions_Params
{
public:
...
struct ABP_MetalWindowShutters_C_SGK_AllowInteraction_Params
{
public:
...
struct ABP_MetalWindowShutters_C_SGK_Interact_Params
{
public:
	class UBP_PlayerInventory_C*                 PlayerInventory;                                   // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
struct ABP_MetalWindowShutters_C_SGK_BuildPartPlaced_Params
{
public:
	class UBP_PlayerInventory_C*                 PlayerInventory;                                   // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
struct ABP_MetalWindowShutters_C_ExecuteUbergraph_BP_MetalWindowShutters_Params
{
public:
	...
	class UAudioComponent*                       CallFunc_SpawnSoundAttached_ReturnValue_1;         // 0x18(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	...
	struct FHitResult                            CallFunc_K2_SetRelativeRotation_SweepHitResult_1;  // 0x138(0xE8)(IsPlainOldData, NoDestructor, ContainsInstancedReference)
	class UBP_PlayerInventory_C*                 K2Node_Event_PlayerInventory;                      // 0x220(0x8)(ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_Event_FromSaveGame;                         // 0x228(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         CallFunc_CheckLocks_AllowOpen;                     // 0x229(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	...
	TArray<class AActor*>                        CallFunc_GetAttachedActors_OutActors;              // 0x230(0x10)(ReferenceParm)
	TArray<class AActor*>                        CallFunc_FilterArray_FilteredArray;                // 0x240(0x10)(ReferenceParm)
	...
	bool                                         CallFunc_Greater_IntInt_ReturnValue;               // 0x255(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                         K2Node_Select_Default;                             // 0x256(0x1)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
