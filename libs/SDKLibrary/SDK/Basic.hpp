...
namespace Offsets
{
	constexpr int32 GObjects          = 0x0699E320;
	constexpr int32 AppendString      = 0x02118690;
	constexpr int32 GNames            = 0x06BEE840;
	constexpr int32 GWorld            = 0x06E1E630;
	constexpr int32 ProcessEvent      = 0x0229EEB0;
