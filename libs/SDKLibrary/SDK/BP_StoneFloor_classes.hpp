...
class ABP_StoneFloor_C final : public ABP_MasterBuildPart_C
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_BP_StoneFloor_C;                    // 0x0380(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
public:
	...
	{
		return StaticBPGeneratedClassImpl<"BP_StoneFloor_C">();
	}
	static class ABP_StoneFloor_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<ABP_StoneFloor_C>();
	}
};
static_assert(alignof(ABP_StoneFloor_C) == 0x000008, "Wrong alignment on ABP_StoneFloor_C");
static_assert(sizeof(ABP_StoneFloor_C) == 0x000438, "Wrong size on ABP_StoneFloor_C");
static_assert(offsetof(ABP_StoneFloor_C, UberGraphFrame_BP_StoneFloor_C) == 0x000380, "Member 'ABP_StoneFloor_C::UberGraphFrame_BP_StoneFloor_C' has a wrong offset!");
static_assert(offsetof(ABP_StoneFloor_C, BP_StairsGridComponent) == 0x000388, "Member 'ABP_StoneFloor_C::BP_StairsGridComponent' has a wrong offset!");
static_assert(offsetof(ABP_StoneFloor_C, BP_TriangleFloorGridComponent3) == 0x000390, "Member 'ABP_StoneFloor_C::BP_TriangleFloorGridComponent3' has a wrong offset!");
static_assert(offsetof(ABP_StoneFloor_C, BP_TriangleFloorGridComponent2) == 0x000398, "Member 'ABP_StoneFloor_C::BP_TriangleFloorGridComponent2' has a wrong offset!");
static_assert(offsetof(ABP_StoneFloor_C, BP_TriangleFloorGridComponent1) == 0x0003A0, "Member 'ABP_StoneFloor_C::BP_TriangleFloorGridComponent1' has a wrong offset!");
static_assert(offsetof(ABP_StoneFloor_C, BP_TriangleFloorGridComponent) == 0x0003A8, "Member 'ABP_StoneFloor_C::BP_TriangleFloorGridComponent' has a wrong offset!");
static_assert(offsetof(ABP_StoneFloor_C, BP_SupportComponent7) == 0x0003B0, "Member 'ABP_StoneFloor_C::BP_SupportComponent7' has a wrong offset!");
static_assert(offsetof(ABP_StoneFloor_C, BP_SupportComponent6) == 0x0003B8, "Member 'ABP_StoneFloor_C::BP_SupportComponent6' has a wrong offset!");
static_assert(offsetof(ABP_StoneFloor_C, BP_SupportComponent5) == 0x0003C0, "Member 'ABP_StoneFloor_C::BP_SupportComponent5' has a wrong offset!");
static_assert(offsetof(ABP_StoneFloor_C, BP_SupportComponent4) == 0x0003C8, "Member 'ABP_StoneFloor_C::BP_SupportComponent4' has a wrong offset!");
static_assert(offsetof(ABP_StoneFloor_C, BP_SupportComponent3) == 0x0003D0, "Member 'ABP_StoneFloor_C::BP_SupportComponent3' has a wrong offset!");
static_assert(offsetof(ABP_StoneFloor_C, BP_SupportComponent2) == 0x0003D8, "Member 'ABP_StoneFloor_C::BP_SupportComponent2' has a wrong offset!");
static_assert(offsetof(ABP_StoneFloor_C, BP_SupportComponent1) == 0x0003E0, "Member 'ABP_StoneFloor_C::BP_SupportComponent1' has a wrong offset!");
static_assert(offsetof(ABP_StoneFloor_C, BP_SupportComponent) == 0x0003E8, "Member 'ABP_StoneFloor_C::BP_SupportComponent' has a wrong offset!");
static_assert(offsetof(ABP_StoneFloor_C, BP_FloorGridComponent3) == 0x0003F0, "Member 'ABP_StoneFloor_C::BP_FloorGridComponent3' has a wrong offset!");
static_assert(offsetof(ABP_StoneFloor_C, BP_FloorGridComponent2) == 0x0003F8, "Member 'ABP_StoneFloor_C::BP_FloorGridComponent2' has a wrong offset!");
static_assert(offsetof(ABP_StoneFloor_C, BP_FloorGridComponent1) == 0x000400, "Member 'ABP_StoneFloor_C::BP_FloorGridComponent1' has a wrong offset!");
static_assert(offsetof(ABP_StoneFloor_C, BP_FloorGridComponent) == 0x000408, "Member 'ABP_StoneFloor_C::BP_FloorGridComponent' has a wrong offset!");
static_assert(offsetof(ABP_StoneFloor_C, BP_WallGridComponent3) == 0x000410, "Member 'ABP_StoneFloor_C::BP_WallGridComponent3' has a wrong offset!");
static_assert(offsetof(ABP_StoneFloor_C, BP_WallGridComponent2) == 0x000418, "Member 'ABP_StoneFloor_C::BP_WallGridComponent2' has a wrong offset!");
static_assert(offsetof(ABP_StoneFloor_C, BP_WallGridComponent1) == 0x000420, "Member 'ABP_StoneFloor_C::BP_WallGridComponent1' has a wrong offset!");
static_assert(offsetof(ABP_StoneFloor_C, BP_WallGridComponent) == 0x000428, "Member 'ABP_StoneFloor_C::BP_WallGridComponent' has a wrong offset!");
static_assert(offsetof(ABP_StoneFloor_C, BuildCollision) == 0x000430, "Member 'ABP_StoneFloor_C::BuildCollision' has a wrong offset!");
