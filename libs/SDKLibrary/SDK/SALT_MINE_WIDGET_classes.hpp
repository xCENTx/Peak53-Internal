...
class USALT_MINE_WIDGET_C : public UUserWidget
{
public:
	...
	static class USALT_MINE_WIDGET_C* GetDefaultObj();

	void Construct();
	void ExecuteUbergraph_SALT_MINE_WIDGET(int32 EntryPoint, bool CallFunc_OpenSource_ReturnValue);
};
