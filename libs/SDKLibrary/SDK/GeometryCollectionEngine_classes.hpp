...
{
public:
	uint8                                        Pad_2A5E[0xC0];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2A6B[0x170];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2A78[0x8];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2A79[0xE8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2A7B[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2A7E[0x1];                                     // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2A85[0x288];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_2A87[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2A96[0x14];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_2A97[0xD6];                                    // Fixing Size Of Struct [ Dumper-7 ]
