...
class UClass* UCR_VaultIt_Mannequin_BothHands_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("CR_VaultIt_Mannequin_BothHands_C");

	return Clss;
}


// CR_VaultIt_Mannequin_BothHands_C CR_VaultIt_Mannequin_BothHands.Default__CR_VaultIt_Mannequin_BothHands_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UCR_VaultIt_Mannequin_BothHands_C* UCR_VaultIt_Mannequin_BothHands_C::GetDefaultObj()
{
	static class UCR_VaultIt_Mannequin_BothHands_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UCR_VaultIt_Mannequin_BothHands_C*>(UCR_VaultIt_Mannequin_BothHands_C::StaticClass()->DefaultObject);
...
// RigVMMemory_Literal CR_VaultIt_Mannequin_BothHands.Default__RigVMMemory_Literal
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)
...
// RigVMMemory_Work CR_VaultIt_Mannequin_BothHands.Default__RigVMMemory_Work
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)
