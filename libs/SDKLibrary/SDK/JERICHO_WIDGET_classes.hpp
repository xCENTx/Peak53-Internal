...
class UJERICHO_WIDGET_C : public UUserWidget
{
public:
	...
	static class UJERICHO_WIDGET_C* GetDefaultObj();

	void Construct();
	void ExecuteUbergraph_JERICHO_WIDGET(int32 EntryPoint, bool CallFunc_OpenSource_ReturnValue);
};
