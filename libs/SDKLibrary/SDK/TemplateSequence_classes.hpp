...
public:
	...
	uint8                                        Pad_135C[0x7C];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_135F[0x260];                                   // Fixing Size After Last Property  [ Dumper-7 ]
	...
	uint8                                        Pad_1361[0x60];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1379[0x70];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_137E[0x58];                                    // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_1384[0x50];                                    // Fixing Size Of Struct [ Dumper-7 ]
