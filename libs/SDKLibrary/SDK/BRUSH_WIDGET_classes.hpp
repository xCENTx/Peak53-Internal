...
class UBRUSH_WIDGET_C : public UUserWidget
{
public:
	...
	static class UBRUSH_WIDGET_C* GetDefaultObj();

	void Construct();
	void ExecuteUbergraph_BRUSH_WIDGET(int32 EntryPoint, bool CallFunc_OpenSource_ReturnValue);
};
