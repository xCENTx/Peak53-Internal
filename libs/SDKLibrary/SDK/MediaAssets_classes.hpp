...
{
public:
	uint8                                        Pad_5[0x58];                                       // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_56[0xB8];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_5C[0x17];                                      // Fixing Size Of Struct [ Dumper-7 ]
...
public:
	...
	uint8                                        Pad_F5[0x28];                                      // Fixing Size After Last Property  [ Dumper-7 ]
