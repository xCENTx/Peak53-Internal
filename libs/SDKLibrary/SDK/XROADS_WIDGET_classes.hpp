...
class UXROADS_WIDGET_C : public UUserWidget
{
public:
	...
	static class UXROADS_WIDGET_C* GetDefaultObj();

	void Construct();
	void ExecuteUbergraph_XROADS_WIDGET(int32 EntryPoint, bool CallFunc_OpenSource_ReturnValue);
};
