...
class UClass* UBP_BuildingMenuPageThree_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("BP_BuildingMenuPageThree_C");

	return Clss;
}


// BP_BuildingMenuPageThree_C BP_BuildingMenuPageThree.Default__BP_BuildingMenuPageThree_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UBP_BuildingMenuPageThree_C* UBP_BuildingMenuPageThree_C::GetDefaultObj()
{
	static class UBP_BuildingMenuPageThree_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UBP_BuildingMenuPageThree_C*>(UBP_BuildingMenuPageThree_C::StaticClass()->DefaultObject);
...
void UBP_BuildingMenuPageThree_C::PopulateCostInformation(const struct FS_CraftingCost& ArrayElementL, const struct FS_BuildPartDetails& BuildPartDetailsL, bool CallFunc_IsValid_ReturnValue, int32 Temp_int_Array_Index_Variable, int32 Temp_int_Loop_Counter_Variable, const struct FS_CraftingCost& CallFunc_Array_Get_Item, int32 CallFunc_Add_IntInt_ReturnValue, int32 CallFunc_Array_Length_ReturnValue, bool CallFunc_Less_IntInt_ReturnValue, class APlayerController* CallFunc_GetOwningPlayer_ReturnValue, class UVerticalBoxSlot* CallFunc_AddChildToVerticalBox_ReturnValue, class UBP_BuildMenuCostPanel_C* CallFunc_Create_ReturnValue, class UBP_PlayerInventory_C* CallFunc_GetComponentByClass_ReturnValue, bool CallFunc_SGK_BuildPartDetails_BuildPartFound, const struct FS_BuildPartDetails& CallFunc_SGK_BuildPartDetails_BuildPartDetails, bool CallFunc_EqualEqual_ByteByte_ReturnValue)
{
	...
	Params::UBP_BuildingMenuPageThree_C_PopulateCostInformation_Params Parms{};
...
void UBP_BuildingMenuPageThree_C::SetCentreInformation(const struct FS_BuildPartDetails& BuildPartDetailsL, bool CallFunc_IsValid_ReturnValue, bool CallFunc_EqualEqual_ByteByte_ReturnValue, bool CallFunc_SGK_BuildPartDetails_BuildPartFound, const struct FS_BuildPartDetails& CallFunc_SGK_BuildPartDetails_BuildPartDetails)
{
	...
	Params::UBP_BuildingMenuPageThree_C_SetCentreInformation_Params Parms{};
...
void UBP_BuildingMenuPageThree_C::ExecuteUbergraph_BP_BuildingMenuPageThree(int32 EntryPoint, bool CallFunc_IsVisible_ReturnValue)
{
	static class UFunction* Func = nullptr;
	...
	Params::UBP_BuildingMenuPageThree_C_ExecuteUbergraph_BP_BuildingMenuPageThree_Params Parms{};
