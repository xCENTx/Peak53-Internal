...
class UCOASTLINE_WIDGET_C : public UUserWidget
{
public:
	...
	static class UCOASTLINE_WIDGET_C* GetDefaultObj();

	void Construct();
	void ExecuteUbergraph_COASTLINE_WIDGET(int32 EntryPoint, bool CallFunc_OpenSource_ReturnValue);
};
