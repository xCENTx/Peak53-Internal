...
class UBREKENRIDGE_WIDGET_C : public UUserWidget
{
public:
	...
	static class UBREKENRIDGE_WIDGET_C* GetDefaultObj();

	void Construct();
	void ExecuteUbergraph_BREKENRIDGE_WIDGET(int32 EntryPoint, bool CallFunc_OpenSource_ReturnValue);
};
