...
struct ABP_GeoContainer2_C_CheckLocks_Params
{
public:
...
struct ABP_GeoContainer2_C_SGK_AllowInteraction_Params
{
public:
...
struct ABP_GeoContainer2_C_SGK_PossibleActions_Params
{
public:
	...
	struct FS_WorldAction                        K2Node_MakeStruct_S_WorldAction;                   // 0x70(0x20)(HasGetValueTypeHash)
	TArray<struct FS_WorldAction>                K2Node_MakeArray_Array;                            // 0x90(0x10)(ReferenceParm)
};

// 0xA (0xA - 0x0)
// Function BP_GeoContainer2.BP_GeoContainer2_C.SGK Interact
struct ABP_GeoContainer2_C_SGK_Interact_Params
{
public:
	class UBP_PlayerInventory_C*                 PlayerInventory;                                   // 0x0(0x8)(BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, NoDestructor, HasGetValueTypeHash)
...
struct ABP_GeoContainer2_C_ExecuteUbergraph_BP_GeoContainer2_Params
{
public:
