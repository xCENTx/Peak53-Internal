...
class ABP_SEAL_WATER_RUINS_M_C : public ABP_SGKMasterCharacter_C
{
public:
	...
	static class ABP_SEAL_WATER_RUINS_M_C* GetDefaultObj();

	void ReceiveBeginPlay();
	void ExecuteUbergraph_BP_SEAL_WATER_RUINS_M(int32 EntryPoint);
};
