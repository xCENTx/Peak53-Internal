...
{
public:
	uint8                                        Pad_1200[0xB8];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_1204[0x30];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
public:
	...
	uint8                                        Pad_1222[0x68];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
