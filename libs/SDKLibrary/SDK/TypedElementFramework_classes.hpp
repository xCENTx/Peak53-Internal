...
{
public:
	uint8                                        Pad_2860[0x920];                                   // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_2869[0x8];                                     // Fixing Size Of Struct [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_286F[0x10];                                    // Fixing Size Of Struct [ Dumper-7 ]
