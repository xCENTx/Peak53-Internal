...
{
public:
	uint8                                         Pad_1B2A[0x20];                                    // 0x0000(0x0020)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
...
public:
	...
	uint8                                         Pad_1B2C[0x2];                                     // 0x0002(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1B2D[0x40];                                    // 0x0000(0x0040)(Fixing Struct Size After Last Property [ Dumper-7 ])
};
