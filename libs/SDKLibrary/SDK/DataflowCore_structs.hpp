...
{
public:
	uint8                                        Pad_30C4[0xC8];                                    // Fixing Size After Last Property  [ Dumper-7 ]
...
{
public:
	uint8                                        Pad_30C6[0x40];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
...
{
public:
	uint8                                        Pad_30C8[0x28];                                    // Fixing Size Of Struct [ Dumper-7 ]
};
