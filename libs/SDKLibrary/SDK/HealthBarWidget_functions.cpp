...
class UClass* UHealthBarWidget_C::StaticClass()
{
	static class UClass* Clss = nullptr;

	if (!Clss)
		Clss = UObject::FindClassFast("HealthBarWidget_C");

	return Clss;
}


// HealthBarWidget_C HealthBarWidget.Default__HealthBarWidget_C
// (Public, ClassDefaultObject, ArchetypeObject, WasLoaded, LoadCompleted)

class UHealthBarWidget_C* UHealthBarWidget_C::GetDefaultObj()
{
	static class UHealthBarWidget_C* Default = nullptr;

	if (!Default)
		Default = static_cast<UHealthBarWidget_C*>(UHealthBarWidget_C::StaticClass()->DefaultObject);
...
struct FSlateBrush UHealthBarWidget_C::Get_JumpIcon_Brush(const struct FSlateColor& K2Node_MakeStruct_SlateColor, const struct FSlateBrush& K2Node_MakeStruct_SlateBrush, const struct FSlateBrush& K2Node_MakeStruct_SlateBrush_1, class ACharacter* CallFunc_GetPlayerCharacter_ReturnValue, class ABP_SGKMasterCharacter_C* K2Node_DynamicCast_AsBP_SGKMaster_Character, bool K2Node_DynamicCast_bSuccess)
{
	...
	Params::UHealthBarWidget_C_Get_JumpIcon_Brush_Params Parms{};
...
float UHealthBarWidget_C::Get_HealthBar_Percent_0(class APlayerController* CallFunc_GetPlayerController_ReturnValue, class ABP_SGKController_C* K2Node_DynamicCast_AsBP_SGKController, bool K2Node_DynamicCast_bSuccess, float CallFunc_Conv_IntToFloat_ReturnValue, float CallFunc_Conv_IntToFloat_ReturnValue_1, double CallFunc_Divide_DoubleDouble_ReturnValue, bool CallFunc_EqualEqual_DoubleDouble_ReturnValue, double CallFunc_Multiply_DoubleDouble_ReturnValue, int32 CallFunc_Round_ReturnValue, int64 CallFunc_Conv_IntToInt64_ReturnValue, const struct FFormatArgumentData& K2Node_MakeStruct_FormatArgumentData, TArray<struct FFormatArgumentData>& K2Node_MakeArray_Array, class FText CallFunc_Format_ReturnValue, float K2Node_FunctionResult_ReturnValue_ImplicitCast, double CallFunc_Divide_DoubleDouble_A_ImplicitCast, double CallFunc_Divide_DoubleDouble_B_ImplicitCast)
{
	...
	Params::UHealthBarWidget_C_Get_HealthBar_Percent_0_Params Parms{};
...
class FText UHealthBarWidget_C::Get_Player_Text_0(class APlayerController* CallFunc_GetPlayerController_ReturnValue, class ABP_SGKController_C* K2Node_DynamicCast_AsBP_SGKController, bool K2Node_DynamicCast_bSuccess)
{
	static class UFunction* Func = nullptr;
	...
	Params::UHealthBarWidget_C_Get_Player_Text_0_Params Parms{};
...
class FText UHealthBarWidget_C::Get_Tag_Text_0(class APlayerController* CallFunc_GetPlayerController_ReturnValue, class ABP_SGKController_C* K2Node_DynamicCast_AsBP_SGKController, bool K2Node_DynamicCast_bSuccess, const class FString& CallFunc_Conv_TextToString_ReturnValue, const class FString& CallFunc_Concat_StrStr_ReturnValue, const class FString& CallFunc_Concat_StrStr_ReturnValue_1, class FText CallFunc_Conv_StringToText_ReturnValue)
{
	...
	Params::UHealthBarWidget_C_Get_Tag_Text_0_Params Parms{};
...
// Function HealthBarWidget.HealthBarWidget_C.Construct
// (BlueprintCosmetic, Event, Public, BlueprintEvent)
// Parameters:

void UHealthBarWidget_C::Construct()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("HealthBarWidget_C", "Construct");
...
// Function HealthBarWidget.HealthBarWidget_C.GetPlayerPing
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UHealthBarWidget_C::GetPlayerPing()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("HealthBarWidget_C", "GetPlayerPing");
...
// Function HealthBarWidget.HealthBarWidget_C.PingTimer
// (BlueprintCallable, BlueprintEvent)
// Parameters:

void UHealthBarWidget_C::PingTimer()
{
	static class UFunction* Func = nullptr;

	if (!Func)
		Func = Class->GetFunction("HealthBarWidget_C", "PingTimer");
