...
public:
	...
	uint8                                         Pad_340E[0x10];                                    // 0x0038(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_340F[0x138];                                   // 0x0028(0x0138)(Fixing Size After Last Property [ Dumper-7 ])
	TMap<class FName, struct FGameplayTagSource>  TagSources;                                        // 0x0160(0x0050)(NativeAccessSpecifierPrivate)
	uint8                                         Pad_3410[0x88];                                    // 0x01B0(0x0088)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_3411[0x2];                                     // 0x004E(0x0002)(Fixing Size After Last Property [ Dumper-7 ])
